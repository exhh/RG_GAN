...
class RGGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            parser.add_argument('--lambda_A', type=float, default=10.0, help='weight for cycle loss (A -> B -> A)')#$10.0
            parser.add_argument('--lambda_B', type=float, default=10.0, help='weight for cycle loss (B -> A -> B)')#$10.0
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D_A', 'G_A', 'cycle_A', 'idt_A', 'D_B', 'G_B', 'cycle_B', 'idt_B', 'tumor_GA']
    ...
    def forward(self):
        ...
        self.LD_GA, _ = self.netLD_GA(self.fake_B)
    ...
    def backward_LD_GA(self):
        lambda_tumor = self.opt.lambda_tumor
        self.LD_GA, _ = self.netLD_GA(self.fake_B.detach())

        self.loss_tumor_GA = weighted_loss2D(self.real_A_label, self.LD_GA, annotate_mask = self.real_A_mask, weight=5.0)

        self.loss_LD = self.loss_tumor_GA
